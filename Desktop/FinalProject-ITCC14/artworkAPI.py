...
put_artwork.add_argument("category", type=str)
...
class postArtwork(Resource):   
    ...
    def post(self, art_id):
        ...
        newArt = ArtworkModel(id=art_id, title=args['title'], color=args['color'], medium=args['medium'])
